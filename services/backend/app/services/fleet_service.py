...
from app.models import AssignmentStatus, DriverStatus, VehicleStatus
...
class VehicleService:
    ...
    def create_vehicle(
        ...
        existing = self.repo.find_vehicle_by_registration(effective, body.registrationNumber)
        if existing:
            raise HTTPException(
        ...
        item = self.repo.create_vehicle(
            tenant_id=effective,
            registration_number=body.registrationNumber.strip(),
            vin=body.vin,
        ...
        self.repo.write_audit(
            ...
            after={"registrationNumber": item["registrationNumber"]},
        )
